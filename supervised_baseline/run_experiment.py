"""CLI entry point for running supervised-only baseline experiments.

Usage::

    # Single cell
    python -m supervised_baseline.run_experiment \\
    ...
    python -m supervised_baseline.run_experiment \\
        ...
        --num-gpus 2 --output-folder results/bertweet/supervised/baseline
...
def _run_one(config: SupervisedBaselineConfig):
    """Run a single supervised baseline experiment. Returns result dict or None."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Supervised-only baseline experiment runner"
    )
...
# Allow `python -m supervised_baseline.run_experiment`
